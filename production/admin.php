...
$sql = "SELECT shop_profiles.id, `ceo_id`, `name`, `motto`, `address`, `email`, `phone_number`, `rc_number`, `verify`, `logo`, `banner`, shop_profiles.created_at FROM `shop_profiles` JOIN payments ON payments.user_id = shop_profiles.ceo_id";
                  ...
                  <div class="x_content">
                      <section class="our-facts">
                                  ...
                                  <div class="row">
                                    <div class="col-md-3">
                                      <div class="count-area-content">
                                        ...
                                        <div class="count-title">Shop Registered</div>
                                      </div>
                                    </div>
                                    <div class="col-md-3">
                                      <div class="count-area-content">
                                    ...
                                    <div class="col-md-3">
                                      <div class="count-area-content">
                                        <div class="count-digit"><?=$shop_pending_verified_total?></div>
                                        <div class="count-title">Pending Verified</div>
                                      </div>
                                    </div>
                                    <div class="col-md-3">
                                      <div class="count-area-content">
                                        <div class="count-digit"><?=$shop_suspended_total?></div>
                                        <div class="count-title">Suspended Account</div>
                                      </div>
                                    </div>
                                </div>
                              </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="profile.php?id=<?=$shop_id?>" class="btn btn-primary btn-sm"><i class="fa fa-folder"></i> View </a>
                          </td>
                        </tr>
                        <?php
                           }
