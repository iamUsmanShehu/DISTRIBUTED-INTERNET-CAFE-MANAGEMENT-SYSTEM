...
$sql = "SELECT `id`, `ceo_id`, `name`, `motto`, `address`, `email`, `phone_number`, `rc_number`, `verify`, `logo`, `banner`, `created_at` FROM `shop_profiles` WHERE verify = 0 AND verify != 1 AND verify != 2";
                                ...
                                <div class="col-lg-12">
                                  <div class="page-title">
                                    <div class="title_left">
                                      <h3>Pending Register Accounts</h3>
                                    </div>
